    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Logo Resimleri Listeleme Sayfası</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=SITE?>">Anasayfa</a></li>
              <li class="breadcrumb-item active">Logo Listesi</li>
            </ol>
          </div>
      </div>
   </div>
	  ...
	  <a href="<?=SITE?>logo-ekle" class="btn btn-success" style="float:right; margin-bottom:10px;"><i class="fa fa-plus">YENİ EKLE</i></a>
         ...
         <div class="card card-info">
              ...
              <div class="card-body">
				...
				$veriler=$DB->VeriGetir("logo","","","ORDER BY ID ASC");
				if($veriler!=false)
				{
					...
					<td>
					<a href="<?=SITE?>logo-duzenle/<?=$veriler[$i]["ID"]?>" class="btn btn-warning btn-sm">Güncelle</a>
					<a href="<?=SITE?>logo-sil/<?=$veriler[$i]["ID"]?>" class="btn btn-danger btn-sm">Sil</a>
				 </td>
					</tr>
